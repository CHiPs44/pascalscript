...
extern "C"
{
    ...
    bool ps_parse_procedure_or_function_declaration(ps_interpreter *interpreter, ps_interpreter_mode mode,
                                                    ps_symbol_kind kind);
    bool ps_parse_procedure_or_function_call(ps_interpreter *interpreter, ps_interpreter_mode mode,
                                             ps_symbol *executable, ps_value *result);
    bool ps_parse_variable_reference(ps_interpreter *interpreter, ps_interpreter_mode mode, ps_symbol **variable);
    ...
    bool ps_parse_function_call(ps_interpreter *interpreter, ps_interpreter_mode mode, ps_symbol *function,
                                ps_value *result);
    ...
    bool ps_parse_constant_expression(ps_interpreter *interpreter, ps_interpreter_mode mode, ps_value *constant);

    /* src/ps_parse_statement.c */
    bool ps_parse_assignment_or_procedure_call(ps_interpreter *interpreter, ps_interpreter_mode mode);
    bool ps_parse_assignment(ps_interpreter *interpreter, ps_interpreter_mode mode, ps_symbol *variable);
    ...
    bool ps_parse_read_or_readln(ps_interpreter *interpreter, ps_interpreter_mode mode, bool newline);
    ...
    /* src/ps_parse_type.c */
    bool ps_parse_type_definition(ps_interpreter *interpreter, ps_interpreter_mode mode);
    bool ps_parse_type_reference(ps_interpreter *interpreter, ps_interpreter_mode mode, ps_symbol **type_symbol,
                                 const char *type_name);
    bool ps_parse_type_reference_enum(ps_interpreter *interpreter, ps_interpreter_mode mode, ps_symbol **type_symbol,
                                      const char *type_name);
    bool ps_parse_type_reference_subrange(ps_interpreter *interpreter, ps_interpreter_mode mode,
                                          ps_symbol **type_symbol, const char *type_name);
    bool ps_parse_type_reference_array(ps_interpreter *interpreter, ps_interpreter_mode mode, ps_symbol **type_symbol,
                                       const char *type_name);
...
#define EXPECT_TOKEN(__PS_TOKEN_TYPE__)                                                                                \
    ...
    {                                                                                                                  \
        ...
        ps_interpreter_set_message(interpreter, "Expected '%s'", ps_token_get_keyword(__PS_TOKEN_TYPE__));             \
