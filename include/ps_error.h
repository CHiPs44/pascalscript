...
extern "C"
{
    ...
    typedef enum e_ps_error
    {
        ...
        /* ----------------- SYMBOL TABLE  ----------------- */
        PS_ERROR_SYMBOL_TABLE_EXISTS,
        PS_ERROR_SYMBOL_TABLE_FULL,
        PS_ERROR_SYMBOL_TABLE_INVALID,
        PS_ERROR_SYMBOL_TABLE_NOT_FOUND,
        /* -------------------- RUNTIME -------------------- */
