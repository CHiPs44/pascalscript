...
void ps_system_init(ps_vm *vm)
{
    // Version MAJOR, MINOR, PATCH, INDEX, STRING
    ps_symbol_table_add(vm->symbols, &ps_symbol_version_major);
    ps_symbol_table_add(vm->symbols, &ps_symbol_version_minor);
    ps_symbol_table_add(vm->symbols, &ps_symbol_version_patch);
    ps_symbol_table_add(vm->symbols, &ps_symbol_version_index);
    // No strings yet!
...
void ps_system_done(ps_vm *vm)
{
    ps_symbol_table_delete(vm->symbols, ps_symbol_version_major.name);
    ps_symbol_table_delete(vm->symbols, ps_symbol_version_minor.name);
    ps_symbol_table_delete(vm->symbols, ps_symbol_version_patch.name);
    ps_symbol_table_delete(vm->symbols, ps_symbol_version_index.name);
    // ...
}
