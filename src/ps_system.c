...
ps_symbol ps_symbol_boolean_false = {
    .scope = PS_SYMBOL_SCOPE_SYSTEM,
...
ps_symbol ps_symbol_boolean_true = {
    .scope = PS_SYMBOL_SCOPE_SYSTEM,
    .kind = PS_SYMBOL_KIND_CONSTANT,
    .name = "TRUE",
...
bool ps_system_init(ps_interpreter *interpreter)
{
    ...
    ps_symbol_table_add(symbols, &ps_symbol_real);
    ps_symbol_table_add(symbols, &ps_symbol_unsigned);

    /**************************************************************************/
    /* CONSTANTS                                                              */
    /**************************************************************************/

    ps_symbol_table_add(symbols, &ps_symbol_boolean_false);
    ps_symbol_table_add(symbols, &ps_symbol_boolean_true);
    ps_symbol_table_add(symbols, &ps_symbol_maxint);
    ps_symbol_table_add(symbols, &ps_symbol_maxuint);
    ps_symbol_table_add(symbols, &ps_symbol_pi);
    ps_symbol_table_add(symbols, &ps_symbol_version_major);
    ps_symbol_table_add(symbols, &ps_symbol_version_minor);
    ps_symbol_table_add(symbols, &ps_symbol_version_patch);
    ps_symbol_table_add(symbols, &ps_symbol_version_index);
    // No strings yet!
