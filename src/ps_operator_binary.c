...
#define NUMBER_FUNC_REAL(__NAME__, __A__, __B__, __OP__)                                                               \
    bool ps_##__NAME__(ps_interpreter *interpreter, ps_value *a, ps_value *b, ps_value *result)                        \
    {                                                                                                                  \
...
NUMBER_FUNC_REAL(divr_ii, i, i, /)
NUMBER_FUNC_REAL(divr_iu, i, i, /)
NUMBER_FUNC_REAL(divr_ui, u, i, /)
NUMBER_FUNC_REAL(divr_uu, u, u, /)
NUMBER_FUNC_REAL(divr_rr, r, r, /)
NUMBER_FUNC_REAL(divr_ri, r, i, /)
NUMBER_FUNC_REAL(divr_ru, r, u, /)
NUMBER_FUNC_REAL(divr_ir, i, r, /)
NUMBER_FUNC_REAL(divr_ur, u, r, /)
                             ...
                             ps_token_type token_type)
{
    ...
    ps_operator_binary_entry *entry = NULL;
    for (size_t i = 0; i < PS_OPERATOR_BINARY_TABLE_COUNT; i++)
    {
