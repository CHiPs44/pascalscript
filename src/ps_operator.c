                           ...
                           ps_token_type token_type)
{
    ...
    case PS_TOKEN_PLUS << 8 | SS: // string + string => string
        ...
        NUMBER_CASE(PS_TOKEN_NE << 8 | IU, i, u, !=, b, PS_TYPE_BOOLEAN)
        NUMBER_CASE(PS_TOKEN_NE << 8 | UI, u, i, !=, b, PS_TYPE_BOOLEAN)
        ...
        NUMBER_CASE(PS_TOKEN_LT << 8 | IU, i, u, <, b, PS_TYPE_BOOLEAN)
        NUMBER_CASE(PS_TOKEN_LT << 8 | UI, u, i, <, b, PS_TYPE_BOOLEAN)
        ...
        NUMBER_CASE(PS_TOKEN_LE << 8 | IU, i, u, <=, b, PS_TYPE_BOOLEAN)
        NUMBER_CASE(PS_TOKEN_LE << 8 | UI, u, i, <=, b, PS_TYPE_BOOLEAN)
        ...
        NUMBER_CASE(PS_TOKEN_GT << 8 | IU, i, u, >, b, PS_TYPE_BOOLEAN)
        NUMBER_CASE(PS_TOKEN_GT << 8 | UI, u, i, >, b, PS_TYPE_BOOLEAN)
        ...
        NUMBER_CASE(PS_TOKEN_GE << 8 | IU, i, u, >=, b, PS_TYPE_BOOLEAN)
        NUMBER_CASE(PS_TOKEN_GE << 8 | UI, u, i, >=, b, PS_TYPE_BOOLEAN)
