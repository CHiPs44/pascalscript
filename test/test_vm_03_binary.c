...
int main(void)
{
    ...
    ps_symbol_t symbol = {"I", KIND_VARIABLE, PS_TYPE_INTEGER, sizeof(ps_integer_t), {0}};
    ...
    ps_symbol_t *n1234 = vm_auto_add_integer(vm, 1234);
    ps_symbol_t *n5678 = vm_auto_add_integer(vm, 5678);
