...
Begin
    ...
    WriteLn('19 ℇ         = ', Exp(1.0)                                                       );
    WriteLn('20 round(ℇ)  = ', Round(Exp(1.0))                                                );
    WriteLn('20 trunc(ℇ)  = ', Trunc(Exp(1.0))                                                );
    WriteLn('20 frac(ℇ)   = ', Frac(Exp(1.0))                                                 );
    WriteLn('21 ln(3)     = ', Ln(3)                                                          );
    WriteLn('21 log10(3)  = ', Log10(3)                                                       );
    WriteLn('21 log2(3)   = ', Log2(3)                                                        );
    WriteLn('21 logn(5,3) = ', LogN(5, 3)                                                     );
